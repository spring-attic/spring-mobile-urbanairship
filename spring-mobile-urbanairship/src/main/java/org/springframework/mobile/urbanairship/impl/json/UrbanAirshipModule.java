...
import org.springframework.mobile.urbanairship.impl.DownloadUrl;
...
public class UrbanAirshipModule extends SimpleModule {
	...
	public void setupModule(SetupContext context) {
		...
		context.setMixInAnnotations(ContentReceipt.class, ContentReceiptMixin.class);
		context.setMixInAnnotations(DownloadUrl.class, DownloadUrlMixin.class);
